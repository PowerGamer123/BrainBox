...
def register():
    ...
    insert_query = "INSERT INTO users (username, email, full_name, phone, password, roles) VALUES (%s, %s, %s, %s, %s, %s)"
    request_insert = (username, email, full_name, phone, hashed_password, roles)
